...
public class Ass71 {
    public static void main(String[] args) {
        ...
        if (gFlag) {
            ...
            System.out.println(
                    "Check the spelling or u may have given wrong option for game!\nExiting...........................");
        }
        sc.close();
    }
}
...
class Cricket implements Game {
    ...
    void displayStats(Double[] teamA, Double[] teamB) {
        ...
        if (teamA[2] > teamB[2]) {
            aStatswon += "\nReg. winning stats: " + Double.toString(teamA[2] - teamB[2])+ " greater.";
        } else {
            bStatswon += "\nReg. winning stats: " + Double.toString(teamB[2] - teamA[2])+ " greater.";
        }
        ...
        if (teamA[5] > teamB[5]) {
            aStatswon += "\nNat. winning stats: " + Double.toString(teamA[5] - teamB[5]) + " greater.";
        } else {
            bStatswon += "\nNat. winning stats: " + Double.toString(teamB[5] - teamA[5]) + " greater.";
        }
        ...
        if (teamA[8] > teamB[8]) {
            aStatswon += "\nInter. winning stats: " + Double.toString(teamA[8] - teamB[8]) + " greater.";
        } else {
            bStatswon += "\nInter. winning stats: " + Double.toString(teamB[8] - teamA[8]) + " greater.";
        }
